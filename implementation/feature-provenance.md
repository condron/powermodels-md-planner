...
|---|-------|-----------|-------|---------------|
| 2099 | PowerModels Accounting phase 2 | Demo Update - March | Open | High — new accounting workflows |
...
|-----------|---------|-------------|-------------------|
| ChartOfAccounts | 14 | CoA setup, account subtypes, filtering, reconciliation prep | RC3-RC4 |
...
| AccountBalance | 2 | Balance snapshots, opening balances | RC4-March |
...
|---------|------------|-----------|-------|------------|
| Excel | 167 | 25 | 192 | Primary host — most development activity |
...
| App | 14 | 0 | 14 | Standalone app (new in RC5) |
...
| 2026-03 | 11 | March demo (partial month) |
