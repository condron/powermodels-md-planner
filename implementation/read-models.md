...
|----------|-------|-------------|-------------|
| ReadModelBase | 46 | Category streams (`$ce-*`) — replays from position 0 | Per-stream replay |
...
| `$ce-ChartOfAccounts` | ChartOfAccountsRm (1) |
| `$ce-ClientWorkspace` | ClientWorkspacesRm, ClientWorkspaceContextRm (2) |
...
| `$ce-DataTableMap` | DataTableMapRm, DataTableMapRm (2) |
| `$ce-Employee` | EmployeeListRm (1) |
| `$ce-EntrySet` | ManualEntriesRm (1) |
| `$ce-FileStore` | FileStoreRm (1) |
| `$ce-ListDataTableMap` | ListDataTableMapRm (1) |
| `$ce-ManagedFinancialModel` | DataSourcesRm, ModelsRm, TaskMetricsRm (3) |
| `$ce-ManualTable` | ModelWorksheetTablesRm, ManualDataTableRm, ManualTableRm (3) |
| `$ce-ManualTableMap` | ManualTableMapRm (1) |
| `$ce-Product` | ProductListRm (1) |
| `$ce-ReferenceDataSeries` | ReferenceDataRm (1) |
| `$ce-ServerFinancialModel` | ModelTemplateRm, ModelListRm, ModelWorksheetTablesRm, DataTableFromTemplateRm, FinancialModelListRm, FinancialModelRm, ModelVerificationRM, ModelsRm, SingleModelTaskMetricsRm (9) |
| `$ce-TasklistItem` | SingleClientTasklistRm, WorkspaceTasklistRm (2) |
| `$ce-TeamSettings` | TeamSettingsRm (1) |
| `$ce-UserDefinedWorksheets` | UserDefinedWorksheetsRm (1) |
...
| ModelTemplateRm | `src/ModelServer/ModelServer/Domain/ModelTemplateRm.cs` | ReadModelBase | 82 | $ce-ServerFinancialModel | Dictionary-based |
...
| ChartOfAccountsRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/AccountingSystem/ChartOfAccountsRm.cs` | ReadModelBase | 4 | $ce-ChartOfAccounts | Dictionary-based |
| ClientWorkspaceContextRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/ClientWorkspaceContextRm.cs` | ReadModelBase | 10 | $ce-ClientWorkspace | Dictionary-based |
...
| DataTableMapRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/DataTableMapRm.cs` | ReadModelBase | 12 | $ce-DataTableMap | Dictionary-based |
...
| FinancialModelRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/FinancialModelRm.cs` | ReadModelBase | 49 | $ce-ServerFinancialModel | Dictionary-based |
...
| ListDataTableMapRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/ListDataTableMapRm.cs` | ReadModelBase | 12 | $ce-ListDataTableMap | Dictionary-based |
...
| ManualTableRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/ManualTableRm.cs` | ReadModelBase | 14 | $ce-ManualTable | ReadModelProperty |
| ModelVerificationRM | `src/ModelServer/SpreadsheetAdapter/ReadModels/ModelVerificationRM.cs` | ReadModelBase | 7 | $ce-ServerFinancialModel | Dictionary-based |
...
| UserDefinedWorksheetsRm | `src/ModelServer/SpreadsheetAdapter/ReadModels/UserDefinedWorksheetsRm.cs` | ReadModelBase | 5 | $ce-UserDefinedWorksheets | ReadModelProperty |
...
| PreprocessorsRm | `src/CustomUI/PowerModels.UIBehavior/Components/TransactionWorkflow/ReadModels/PreprocessorsRm.cs` | TransientSubscriber | 2 | Bus (live only) | HashSet-based |
