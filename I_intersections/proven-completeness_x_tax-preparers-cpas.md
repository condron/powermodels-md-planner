...
- proven-completeness—trust in automated categorization
- proven-completeness—professional judgment preservation
- proven-completeness—review efficiency
...
- Add `trust in automated categorization` as a synonym or linked facet on `proven-completeness` (matches audience concern).
- Add `professional judgment preservation` as a synonym or linked facet on `proven-completeness` (matches audience concern).
- Add `review efficiency` as a synonym or linked facet on `proven-completeness` (matches audience concern).
