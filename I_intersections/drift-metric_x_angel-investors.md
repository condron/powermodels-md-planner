...
- drift-metric—early traction and validation
- drift-metric—capital efficiency and scrappiness
- drift-metric—team capability and hustle
...
- Add `early traction and validation` as a synonym or linked facet on `drift-metric` (matches audience concern).
- Add `capital efficiency and scrappiness` as a synonym or linked facet on `drift-metric` (matches audience concern).
- Add `team capability and hustle` as a synonym or linked facet on `drift-metric` (matches audience concern).
