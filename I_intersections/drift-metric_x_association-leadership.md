---
type: intersection
id: drift-metric_x_association-leadership
aspect: drift-metric
...
q_holes:
- drift-metric—member value and retention
- drift-metric—association relevance and modernization
- drift-metric—revenue from partnerships and sponsorships
- drift-metric—CPE programming quality
- drift-metric—member firm competitiveness
...
- Add `revenue from partnerships and sponsorships` as a synonym or linked facet on `drift-metric` (matches audience concern).
- Add `CPE programming quality` as a synonym or linked facet on `drift-metric` (matches audience concern).
- Add `member firm competitiveness` as a synonym or linked facet on `drift-metric` (matches audience concern).
