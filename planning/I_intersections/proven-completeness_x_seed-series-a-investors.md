...
- proven-completeness—go-to-market repeatability
- proven-completeness—unit economics and scalability
- proven-completeness—competitive positioning and moats
...
- Add `unit economics and scalability` as a synonym or linked facet on `proven-completeness` (matches audience concern).
- Add `competitive positioning and moats` as a synonym or linked facet on `proven-completeness` (matches audience concern).
